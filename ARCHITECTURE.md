...
> **状态提示（2026-09-07）**：本文为整合早期（多网关上墙如 ds_v4_cli）的产物，部分已与现状脱节，**仅供历史与设计意图参考**，不作为运行事实。当前以 `docs/`（Obsidian 知识库）为准：全局事实见 `docs/design/AI基础设施/00-总览.md`，各服务见 `docs/design/AI基础设施/服务/<id>.md`，实时运行态以 `gateway_runtime.json` 为准。
