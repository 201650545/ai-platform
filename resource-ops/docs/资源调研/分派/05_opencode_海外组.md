...
| # | 平台 | 说明 |
|---|------|------|
| 1 | Cohere | 谷歌/GitHub 登录，新户信用 |
| 2 | Replicate | 免费档 + 新户信用 |
| 3 | Stability / 生图站 | 谷歌登录，免费档生成额度 |
| 4 | fal.ai | 谷歌登录，新户信用 |
...
> ⚠️ **并发注意**：海外组与包 4 共用同一已登录 Chrome，别与包 4 同时开浏览器抢 tab。
...
- **只写**：`docs/资源调研/结果/结果_opencode.md`（追加平台记录）
