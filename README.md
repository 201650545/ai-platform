...
| 项目 | Slug | 表数 | 记录数 | 说明 |
|---|---|---|---|---|
| AI 自助资源库 | `ai-resource` | 2 | ~42 | AI 资源能力规格与实例（公开能力+实例两表；凭证/账号/日志私密） |
| 英语学习系统 | `learning-english` | 4 | 6131 | 词汇、文本、计划、日志 |
| 公考系统 | `civil-service-exam` | 9 | — | 公考知识点、练习、错题 |
| 教资系统 | `teacher-cert-exam` | 7 | — | 教资考点、真题、错题 |
| 教师成长 | `teacher-growth` | 5 | — | 教师成长知识点、日志、自测 |

### ai-resource 数据表

| 飞书表名 | Slug | 字段数 | 记录数 |
|---|---|---|---|
| 资源能力规格表 | `capabilities` | 19 | ~21 |
| 资源实例表 | `instances` | 20 | ~21 |
